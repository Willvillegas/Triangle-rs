...
fn test_inc() {
    ...
    let expected_program = Program::new(LetCommand(LetCommandState::new(
        Arc::new(Mutex::new(SequentialDeclaration(
            SequentialDeclarationState::new(
                Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(
                    Identifier::new("x"),
                    Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(
                        Identifier::new("Integer"),
                    )))),
                )))),
                Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(
                    Identifier::new("inc"),
                        ...
                        UnaryExpression(UnaryExpressionState::new(
                            ...
                            CallExpression(CallExpressionState::new(
                                ...
                                EmptyActualParameterSequence(
                                    EmptyActualParameterSequenceState::new(),
                                ),
                            )),
                        )),
                        SequentialCommand(SequentialCommandState::new(
                            CallCommand(CallCommandState::new(
                                ...
                                SingleActualParameterSequence(
                                    SingleActualParameterSequenceState::new(VarActualParameter(
                                        VarActualParameterState::new(SimpleVname(
                                ...
                                SingleActualParameterSequence(
                                    SingleActualParameterSequenceState::new(ConstActualParameter(
                                        ConstActualParameterState::new(VnameExpression(
                                            VnameExpressionState::new(SimpleVname(
                                                SimpleVnameState::new(Identifier::new("ch")),
                                            )),
                                        )),
                                    )),
    ...
    let expected_program = Program::new(LetCommand(LetCommandState::new(
        Arc::new(Mutex::new(SequentialDeclaration(
            SequentialDeclarationState::new(
                ...
                Arc::new(Mutex::new(FuncDeclaration(FuncDeclarationState::new(
                    Identifier::new("odd"),
                    SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(
                            ...
                            SequentialDeclarationState::new(
                                Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(
                                    ...
                                    Arc::new(Mutex::new(SimpleTypeDenoter(
                                        SimpleTypeDenoterState::new(Identifier::new("Integer")),
                                    ))),
                                )))),
                                Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(
                                    Identifier::new("y"),
                                                    ...
                                                    ConstActualParameterState::new(
                                                        BinaryExpression(
                                                            BinaryExpressionState::new(
                                                                VnameExpression(
                                                                    VnameExpressionState::new(
                                                                        SimpleVname(
                                                                            SimpleVnameState::new(
                                                                                Identifier::new(
                                                                                    "b",
                                                                                ),
                                                                            ),
    ...
    let expected_program = Program::new(LetCommand(LetCommandState::new(
        Arc::new(Mutex::new(SequentialDeclaration(
            SequentialDeclarationState::new(
                Arc::new(Mutex::new(SequentialDeclaration(
                    SequentialDeclarationState::new(
                        Arc::new(Mutex::new(TypeDeclaration(TypeDeclarationState::new(
                            Identifier::new("Date"),
                            Arc::new(Mutex::new(RecordTypeDenoter(RecordTypeDenoterState::new(
                                MultipleFieldTypeDenoter(MultipleFieldTypeDenoterState::new(
                                    ...
                                    MultipleFieldTypeDenoter(MultipleFieldTypeDenoterState::new(
                                        ...
                                        SingleFieldTypeDenoter(SingleFieldTypeDenoterState::new(
                                            Identifier::new("d"),
                                            Arc::new(Mutex::new(SimpleTypeDenoter(
                                                SimpleTypeDenoterState::new(Identifier::new(
                                                    "Integer",
                                                )),
                                            ))),
                                        )),
                            ...
                            SequentialDeclarationState::new(
                                Arc::new(Mutex::new(TypeDeclaration(TypeDeclarationState::new(
                                    ...
                                    Arc::new(Mutex::new(RecordTypeDenoter(
                                        RecordTypeDenoterState::new(MultipleFieldTypeDenoter(
                                ...
                                Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(
                                    Identifier::new("d"),
                                    Arc::new(Mutex::new(SimpleTypeDenoter(
                                        SimpleTypeDenoterState::new(Identifier::new("Date")),
                                    ))),
                                )))),
                            ),
                        ))),
                            ...
                            SequentialCommand(SequentialCommandState::new(
                                SequentialCommand(SequentialCommandState::new(
                                    CallCommand(CallCommandState::new(
                                        ...
                                        SingleActualParameterSequence(
                                            SingleActualParameterSequenceState::new(
                                                VarActualParameter(VarActualParameterState::new(
                                                    DotVname(DotVnameState::new(
                                                        SimpleVname(SimpleVnameState::new(
                                                            Identifier::new("d"),
                                                        )),
...
fn test_print_array() {
    ...
    let mut parser = Parser::new(Scanner::new(source_file));
    let expected_program = 
Program::new(LetCommand(LetCommandState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("arr"), Arc::new(Mutex::new(ArrayTypeDenoter(ArrayTypeDenoterState::new(IntegerLiteral::new("5"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("println"), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("x"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))), SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("putint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("x"))))))))))), CallCommand(CallCommandState::new(Identifier::new("puteol"), EmptyActualParameterSequence(EmptyActualParameterSequenceState::new()))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("iterate"), MultipleFormalParameterSequence(MultipleFormalParameterSequenceState::new(ProcFormalParameter(ProcFormalParameterState::new(Identifier::new("f"), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("n"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("arr"), Arc::new(Mutex::new(ArrayTypeDenoter(ArrayTypeDenoterState::new(IntegerLiteral::new("5"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))))), LetCommand(LetCommandState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("i"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))), SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), WhileCommand(WhileCommandState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("<"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("5"))))), SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("f"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("arr"))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))))))))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))))))))))))))))))), LetCommand(LetCommandState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("i"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), WhileCommand(WhileCommandState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("<"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("5"))))), SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("arr"))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))))), BinaryExpression(BinaryExpressionState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))), Operator::new("*"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("100"))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))))))))), CallCommand(CallCommandState::new(Identifier::new("iterate"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ProcActualParameter(ProcActualParameterState::new(Identifier::new("println"))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("arr"))))))))))))))))))));
    let actual_program = parser.parse_program();
    assert_eq!(expected_program, actual_program);
}
...
fn test_freq() {
    ...
    let mut parser = Parser::new(Scanner::new(source_file));
    let expected_program = 
Program::new(LetCommand(LetCommandState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("initialize"), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(VarFormalParameter(VarFormalParameterState::new(Identifier::new("arr"), Arc::new(Mutex::new(ArrayTypeDenoter(ArrayTypeDenoterState::new(IntegerLiteral::new("26"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))), LetCommand(LetCommandState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("i"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))), SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), WhileCommand(WhileCommandState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("<"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("26"))))), SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("arr"))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("increment"), MultipleFormalParameterSequence(MultipleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("ch"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Char"))))))), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(VarFormalParameter(VarFormalParameterState::new(Identifier::new("freq"), Arc::new(Mutex::new(ArrayTypeDenoter(ArrayTypeDenoterState::new(IntegerLiteral::new("26"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))))), LetCommand(LetCommandState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("idx"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))), SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("idx"))), BinaryExpression(BinaryExpressionState::new(CallExpression(CallExpressionState::new(Identifier::new("ord"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("ch"))))))))))), Operator::new("-"), CallExpression(CallExpressionState::new(Identifier::new("ord"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("a"))))))))))))), IfCommand(IfCommandState::new(BinaryExpression(BinaryExpressionState::new(BinaryExpression(BinaryExpressionState::new(CallExpression(CallExpressionState::new(Identifier::new("ord"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("ch"))))))))))), Operator::new(">="), CallExpression(CallExpressionState::new(Identifier::new("ord"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("a"))))))))))), Operator::new("/\\"), BinaryExpression(BinaryExpressionState::new(CallExpression(CallExpressionState::new(Identifier::new("ord"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("ch"))))))))))), Operator::new("<="), CallExpression(CallExpressionState::new(Identifier::new("ord"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("z"))))))))))))), AssignCommand(AssignCommandState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("freq"))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("idx"))))))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("freq"))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("idx"))))))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))), AssignCommand(AssignCommandState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("freq"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), VnameExpression(VnameExpressionState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("freq"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))))))))))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("calculatefreqs"), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(VarFormalParameter(VarFormalParameterState::new(Identifier::new("freq"), Arc::new(Mutex::new(ArrayTypeDenoter(ArrayTypeDenoterState::new(IntegerLiteral::new("26"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))), LetCommand(LetCommandState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("ch"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Char"))))))))), WhileCommand(WhileCommandState::new(UnaryExpression(UnaryExpressionState::new(Operator::new("\\"), CallExpression(CallExpressionState::new(Identifier::new("eol"), EmptyActualParameterSequence(EmptyActualParameterSequenceState::new()))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("get"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("ch"))))))))), CallCommand(CallCommandState::new(Identifier::new("increment"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("ch"))))))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("freq"))))))))))))), EmptyCommand(EmptyCommandState::new()))))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("displayfreqs"), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("freq"), Arc::new(Mutex::new(ArrayTypeDenoter(ArrayTypeDenoterState::new(IntegerLiteral::new("26"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))), LetCommand(LetCommandState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("i"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), WhileCommand(WhileCommandState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("<"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("26"))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CallExpression(CallExpressionState::new(Identifier::new("chr"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(BinaryExpression(BinaryExpressionState::new(CallExpression(CallExpressionState::new(Identifier::new("ord"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("a"))))))))), Operator::new("+"), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))))))))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("="))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new(">"))))))))))), CallCommand(CallCommandState::new(Identifier::new("putint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("freq"))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))))))))))))))), CallCommand(CallCommandState::new(Identifier::new("puteol"), EmptyActualParameterSequence(EmptyActualParameterSequenceState::new()))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))))))))), EmptyCommand(EmptyCommandState::new()))))))))))))), LetCommand(LetCommandState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("freq"), Arc::new(Mutex::new(ArrayTypeDenoter(ArrayTypeDenoterState::new(IntegerLiteral::new("26"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("initialize"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("freq"))))))))), CallCommand(CallCommandState::new(Identifier::new("calculatefreqs"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("freq"))))))))))), CallCommand(CallCommandState::new(Identifier::new("displayfreqs"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("freq"))))))))))))))))));
    let actual_program = parser.parse_program();
    assert_eq!(expected_program, actual_program);
}
...
fn test_rationals() {
    ...
    let mut parser = Parser::new(Scanner::new(source_file));
    let expected_program = 
Program::new(LetCommand(LetCommandState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(TypeDeclaration(TypeDeclarationState::new(Identifier::new("Rational"), Arc::new(Mutex::new(RecordTypeDenoter(RecordTypeDenoterState::new(MultipleFieldTypeDenoter(MultipleFieldTypeDenoterState::new(Identifier::new("numerator"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))), SingleFieldTypeDenoter(SingleFieldTypeDenoterState::new(Identifier::new("denominator"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))))))), Arc::new(Mutex::new(FuncDeclaration(FuncDeclarationState::new(Identifier::new("gcd"), MultipleFormalParameterSequence(MultipleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("x"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("y"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))), IfExpression(IfExpressionState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("y"))))), Operator::new("="), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("x"))))), CallExpression(CallExpressionState::new(Identifier::new("gcd"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("y"))))))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("x"))))), Operator::new("//"), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("y"))))))))))))))))))))))))), Arc::new(Mutex::new(FuncDeclaration(FuncDeclarationState::new(Identifier::new("makerational"), MultipleFormalParameterSequence(MultipleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("n"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("d"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))), LetExpression(LetExpressionState::new(Arc::new(Mutex::new(ConstDeclaration(ConstDeclarationState::new(Identifier::new("g"), CallExpression(CallExpressionState::new(Identifier::new("gcd"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("n"))))))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("d"))))))))))))))))), RecordExpression(RecordExpressionState::new(MultipleRecordAggregate(MultipleRecordAggregateState::new(Identifier::new("numerator"), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("n"))))), Operator::new("/"), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("g"))))))), SingleRecordAggregate(SingleRecordAggregateState::new(Identifier::new("denominator"), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("d"))))), Operator::new("/"), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("g"))))))))))))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("readrational"), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(VarFormalParameter(VarFormalParameterState::new(Identifier::new("r"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("getint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r"))), Identifier::new("numerator"))))))))), CallCommand(CallCommandState::new(Identifier::new("getint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r"))), Identifier::new("denominator"))))))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r"))), CallExpression(CallExpressionState::new(Identifier::new("makerational"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r"))), Identifier::new("numerator"))))))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r"))), Identifier::new("denominator"))))))))))))))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("displayrational"), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("r"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("{"))))))))), CallCommand(CallCommandState::new(Identifier::new("putint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r"))), Identifier::new("numerator"))))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new(","))))))))))), CallCommand(CallCommandState::new(Identifier::new("putint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r"))), Identifier::new("denominator"))))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("}"))))))))))), CallCommand(CallCommandState::new(Identifier::new("puteol"), EmptyActualParameterSequence(EmptyActualParameterSequenceState::new()))))), EmptyCommand(EmptyCommandState::new()))))))))))), Arc::new(Mutex::new(FuncDeclaration(FuncDeclarationState::new(Identifier::new("addrational"), MultipleFormalParameterSequence(MultipleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("r1"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))))), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("r2"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))))))))), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))), LetExpression(LetExpressionState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(ConstDeclaration(ConstDeclarationState::new(Identifier::new("num"), BinaryExpression(BinaryExpressionState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r1"))), Identifier::new("numerator"))))), Operator::new("*"), VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r2"))), Identifier::new("denominator"))))))), Operator::new("+"), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r1"))), Identifier::new("denominator"))))), Operator::new("*"), VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r2"))), Identifier::new("numerator"))))))))))))), Arc::new(Mutex::new(ConstDeclaration(ConstDeclarationState::new(Identifier::new("denom"), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r1"))), Identifier::new("denominator"))))), Operator::new("*"), VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r2"))), Identifier::new("denominator"))))))))))))))), CallExpression(CallExpressionState::new(Identifier::new("makerational"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("num"))))))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("denom"))))))))))))))))))))))), Arc::new(Mutex::new(FuncDeclaration(FuncDeclarationState::new(Identifier::new("subrational"), MultipleFormalParameterSequence(MultipleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("r1"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))))), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("r2"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))))))))), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))), LetExpression(LetExpressionState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(ConstDeclaration(ConstDeclarationState::new(Identifier::new("num"), BinaryExpression(BinaryExpressionState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r1"))), Identifier::new("numerator"))))), Operator::new("*"), VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r2"))), Identifier::new("denominator"))))))), Operator::new("-"), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r1"))), Identifier::new("denominator"))))), Operator::new("*"), VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r2"))), Identifier::new("numerator"))))))))))))), Arc::new(Mutex::new(ConstDeclaration(ConstDeclarationState::new(Identifier::new("denom"), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r1"))), Identifier::new("denominator"))))), Operator::new("*"), VnameExpression(VnameExpressionState::new(DotVname(DotVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r2"))), Identifier::new("denominator"))))))))))))))), CallExpression(CallExpressionState::new(Identifier::new("makerational"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("num"))))))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("denom"))))))))))))))))))))))), Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("a"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))))))))))), Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("b"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))))))))))), Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("c"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Rational"))))))))))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("readrational"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("a"))))))))), CallCommand(CallCommandState::new(Identifier::new("displayrational"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("a"))))))))))))), CallCommand(CallCommandState::new(Identifier::new("readrational"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("b"))))))))))), CallCommand(CallCommandState::new(Identifier::new("displayrational"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("b"))))))))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("c"))), CallExpression(CallExpressionState::new(Identifier::new("addrational"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("a"))))))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("b"))))))))))))))))), CallCommand(CallCommandState::new(Identifier::new("displayrational"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("c"))))))))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("c"))), CallExpression(CallExpressionState::new(Identifier::new("subrational"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("a"))))))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("b"))))))))))))))))), CallCommand(CallCommandState::new(Identifier::new("displayrational"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("c"))))))))))))), EmptyCommand(EmptyCommandState::new()))))));
    let actual_program = parser.parse_program();
    assert_eq!(expected_program, actual_program);
}
...
fn test_eqnoteq() {
    ...
    let mut parser = Parser::new(Scanner::new(source_file));
    let expected_program = 
Program::new(LetCommand(LetCommandState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("x"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))), Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("y"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("getint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("x"))))))))), CallCommand(CallCommandState::new(Identifier::new("getint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("y"))))))))))), IfCommand(IfCommandState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("x"))))), Operator::new("="), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("y"))))))), CallCommand(CallCommandState::new(Identifier::new("putint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))))), CallCommand(CallCommandState::new(Identifier::new("putint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("2"))))))))))))))));
...
fn test_nestedarrays() {
    ...
    let mut parser = Parser::new(Scanner::new(source_file));
    let expected_program = 
Program::new(LetCommand(LetCommandState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(TypeDeclaration(TypeDeclarationState::new(Identifier::new("Matrix"), Arc::new(Mutex::new(ArrayTypeDenoter(ArrayTypeDenoterState::new(IntegerLiteral::new("3"), Arc::new(Mutex::new(ArrayTypeDenoter(ArrayTypeDenoterState::new(IntegerLiteral::new("4"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))))))), Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("mat"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Matrix"))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("displayprompt"), EmptyFormalParameterSequence(EmptyFormalParameterSequenceState::new()), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("E"))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("n"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("t"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("e"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("r"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new(" "))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("n"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("u"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("m"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("b"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("e"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new("r"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new(":"))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new(" "))))))))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("initialisematrix"), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(VarFormalParameter(VarFormalParameterState::new(Identifier::new("m"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Matrix"))))))))), LetCommand(LetCommandState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("i"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))), Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("j"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))), SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), WhileCommand(WhileCommandState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("<"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("3"))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), WhileCommand(WhileCommandState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))))), Operator::new("<"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("4"))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("displayprompt"), EmptyActualParameterSequence(EmptyActualParameterSequenceState::new()))), CallCommand(CallCommandState::new(Identifier::new("getint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SubscriptVname(SubscriptVnameState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("m"))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))))))))))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))))))))))))))))))), Arc::new(Mutex::new(ProcDeclaration(ProcDeclarationState::new(Identifier::new("displaymatrix"), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("m"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Matrix"))))))))), LetCommand(LetCommandState::new(Arc::new(Mutex::new(SequentialDeclaration(SequentialDeclarationState::new(Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("i"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))), Arc::new(Mutex::new(VarDeclaration(VarDeclarationState::new(Identifier::new("j"), Arc::new(Mutex::new(SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))))), SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), WhileCommand(WhileCommandState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("<"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("3"))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("0"))))), WhileCommand(WhileCommandState::new(BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))))), Operator::new("<"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("4"))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("putint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SubscriptVname(SubscriptVnameState::new(SubscriptVname(SubscriptVnameState::new(SimpleVname(SimpleVnameState::new(Identifier::new("m"))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))))), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))))))))))))))), CallCommand(CallCommandState::new(Identifier::new("put"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(CharacterExpression(CharacterExpressionState::new(CharacterLiteral::new(" "))))))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("j"))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("i"))))), Operator::new("+"), IntegerExpression(IntegerExpressionState::new(IntegerLiteral::new("1"))))))))), CallCommand(CallCommandState::new(Identifier::new("puteol"), EmptyActualParameterSequence(EmptyActualParameterSequenceState::new()))))))))))))))))))), SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("initialisematrix"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("mat"))))))))), CallCommand(CallCommandState::new(Identifier::new("displaymatrix"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("mat"))))))))))))))));
