...
Program::new(LetCommand(LetCommandState::new(SequentialDeclaration(SequentialDeclarationState::new(SequentialDeclaration(SequentialDeclarationState::new(SequentialDeclaration(SequentialDeclarationState::new(VarDeclaration(VarDeclarationState::new(Identifier::new("x"), SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))), VarDeclaration(VarDeclarationState::new(Identifier::new("y"), SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))), VarDeclaration(VarDeclarationState::new(Identifier::new("s"), SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))), ProcDeclaration(ProcDeclarationState::new(Identifier::new("add"), MultipleFormalParameterSequence(MultipleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("a"), SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))), MultipleFormalParameterSequence(MultipleFormalParameterSequenceState::new(ConstFormalParameter(ConstFormalParameterState::new(Identifier::new("b"), SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))), SingleFormalParameterSequence(SingleFormalParameterSequenceState::new(VarFormalParameter(VarFormalParameterState::new(Identifier::new("r"), SimpleTypeDenoter(SimpleTypeDenoterState::new(Identifier::new("Integer"))))))))))), AssignCommand(AssignCommandState::new(SimpleVname(SimpleVnameState::new(Identifier::new("r"))), BinaryExpression(BinaryExpressionState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("a"))))), Operator::new("+"), VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("b"))))))))))))), SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(SequentialCommand(SequentialCommandState::new(CallCommand(CallCommandState::new(Identifier::new("getint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("x"))))))))), CallCommand(CallCommandState::new(Identifier::new("getint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("y"))))))))))), CallCommand(CallCommandState::new(Identifier::new("add"), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("x"))))))), MultipleActualParameterSequence(MultipleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("y"))))))), SingleActualParameterSequence(SingleActualParameterSequenceState::new(VarActualParameter(VarActualParameterState::new(SimpleVname(SimpleVnameState::new(Identifier::new("s"))))))))))))))), CallCommand(CallCommandState::new(Identifier::new("putint"), SingleActualParameterSequence(SingleActualParameterSequenceState::new(ConstActualParameter(ConstActualParameterState::new(VnameExpression(VnameExpressionState::new(SimpleVname(SimpleVnameState::new(Identifier::new("s"))))))))))))))));
